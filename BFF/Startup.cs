...
namespace BackendForFrontend
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            // Pass the SSL connection
            var hostEndpoint = Configuration["WeatherApiEndpoint"];
            services.AddHttpClient(hostEndpoint).ConfigurePrimaryHttpMessageHandler(_ => new HttpClientHandler
            {
